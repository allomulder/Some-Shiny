...
water <- read_csv2('https://raw.githubusercontent.com/allomulder/Some-Shiny/master/water_new.csv', col_names = T) #вкачиваем файл
water <- water[,1:7] #убираем лишние колонки
